...
def bulkDetails(testApps = ['org.mozilla.focus', 'com.non.existing.app']):
    # BULK DETAILS
...
def details(testApps = ['org.mozilla.focus', 'com.non.existing.app']):
    # DETAILS
    print('\nGetting details for %s\n' % testApps[0])
    details = server.details(testApps[0])
    print(details)

def reviews(testApps = ['org.mozilla.focus', 'com.non.existing.app']):
    # REVIEWS
